...
public class HomeLoansPage extends BaseAPI {
    ...
    @FindBy(xpath = WEB_ELEMENT_HOME_LOANS_TEXT_LINK)
    public WebElement homeLoansTextLink2;
    @FindBy(xpath = WEB_ELEMENT_MORTGAGE_HOME_LOAN)
    public WebElement mortgageHomeLoans;
    ...
    public void clickHomeLoansText1(){

        clickElement(homeLoansTextLink2);
    }
    public void clickMortgageHomeLoans(){
        waitForElementToBeSelected(mortgageHomeLoans);
        clickElement(mortgageHomeLoans);
    }
    public void clickHomeLoansTextLink(){
        waitForElementToBeClickable(homeLoansTextLink);
    ...
    public void enterUserName(String userName){
        waitForVisibilityOfElement(logonFrame);
...
//        clickElement(signInBtn2);
    ...
    public void enterUserPassword(String userPassword) {
       ...
       sendKeysToElement(passwordField ,userPassword);
