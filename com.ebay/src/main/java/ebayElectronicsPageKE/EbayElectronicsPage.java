...
public class EbayElectronicsPage extends BaseAPI {
    ...
    @FindBy(xpath = WEB_ELEMENT_BUSINESS_ACC_RADIO_BUTTON)
    ...
    @FindBy(xpath = WEB_ELEMENT_CAMERAS_DRONES_LINK)
    public WebElement camerasAndDronesTextLink;
    @FindBy(xpath = WEB_ELEMENT_RED_DRONE_IMAGE)
    public WebElement redDroneImage;
    @FindBy(xpath = WEB_ELEMENT_CAR_ELECTRONICS_LINK)
    public WebElement carElectronics;
    @FindBy(xpath = WEB_ELEMENT_GPS_IMG)
    public WebElement gpsImg;
    @FindBy(xpath = WEB_ELEMENT_TREAT_HER_BTN)
    public WebElement treatHerBtn;
    @FindBy(xpath = WEB_ELEMENT_LAPTOP_IMG)
    public WebElement laptopImg;

    @FindBy(xpath = WEB_ELEMENT_BUSINESS_NAME_INPUT_BOX)
    public WebElement businessName;
    @FindBy(xpath = WEB_ELEMENT_BUSINESS_EMAIL_INPUT_BOX)
    public WebElement businessEMail;
    @FindBy(xpath = WEB_ELEMENT_PASSWORD_bz_INPUT_BOX)
    public WebElement passwordBz;
    @FindBy(xpath = WEB_ELEMENT_VERIFYING_CREATE_BUSINESS_ACC_BUTTON)
    public WebElement businessAccBtn;
...
//            Thread.sleep(2000);
    ...
    public void clickCamerasAndDronesTextLink() {
        clickElement(camerasAndDronesTextLink);
    }

    public void clickCarElectronicsTextLink() {
        clickElement(carElectronics);
    }

    public void clickTreatHerButton() {

        clickElement(treatHerBtn);
    }

    //**********************

    public void entersBusinessName(String names) {

        sendKeysToElement(businessName, names);
    }

    public void entersBusinessEmail(String emails) {

        sendKeysToElement(businessEMail, emails);

    }

    public void entersBusinessPassword(String passwords) {

        sendKeysToElement(passwordBz,passwords);
    }
}